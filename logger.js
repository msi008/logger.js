/**
 * Created by fengge on 2017/8/23.
 */
...
})("BugTrack", this, function(){
    "use strict";
    var BugTrack = function(options){
        var defaultOptions = {};
    ...
    BugTrack.prototype = {
        ...
        upBug : function () {
            ...
            window.onerror = function (errorMessage, scriptURI, lineNumber, columnNumber, errorObj) {
                ...
                var logger = {};
                var system = new browserDetection();
                logger.browser = system.browser+system.version;
                logger.system = system.os;
                logger.type = "error";
                logger.error = errorObj.stack;
                logger.domain = window.location.host;
                that.socket.emit('logger_info', logger);
            }
        },
        ...
        logger : function (info) {
            ...
            logger.info = info;
            logger.domain = window.location.host;
            this.socket.emit('logger_info', logger);
        },
        ...
        _addSocket : function () {
            ...
            this.socket.on('anything', function (err) {
                console.log(err);
            });
